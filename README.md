...
## 项目简介
这是一个个人网站项目，采用现代化的响应式设计，为访问者提供良好的浏览体验。项目包含前端展示页面和完整的后台管理系统。
...
## 部署
本项目使用 GitHub Pages 部署，访问地址：https://sambohrith.github.io/Lincoln-zhu

## 本地开发
### 前端页面开发
1. 克隆项目 
   ```bash
   git clone https://github.com/sambohrith/Lincoln-zhu.git
   ```
2. 打开项目
   ```bash
   cd Lincoln-zhu
